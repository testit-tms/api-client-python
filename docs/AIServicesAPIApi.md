...
> AIServiceModelApiResultIReply api_v2_external_services_id_ai_models_post(id)
...
from testit_api_client.model.ai_service_model_api_result_i_reply import AIServiceModelApiResultIReply

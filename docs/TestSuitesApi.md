...
with testit_api_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = test_suites_api.TestSuitesApi(api_client)
    api_v2_test_suites_post_request1 = ApiV2TestSuitesPostRequest1(None) # ApiV2TestSuitesPostRequest1 |  (optional)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Create test suite
        api_response = api_instance.api_v2_test_suites_post(api_v2_test_suites_post_request1=api_v2_test_suites_post_request1)
        pprint(api_response)
    except testit_api_client.ApiException as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **api_v2_test_suites_post_request1** | [**ApiV2TestSuitesPostRequest1**](ApiV2TestSuitesPostRequest1.md)|  | [optional]
...
with testit_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Edit test suite
        api_instance.api_v2_test_suites_put(api_v2_test_suites_post_request=api_v2_test_suites_post_request)
    except testit_api_client.ApiException as e:

...
**event_types** | [**[WebHookEventTypeModel], none_type**](WebHookEventTypeModel.md) | Specifies a webhook event types to search for | [optional] 
**methods** | [**[RequestTypeModel], none_type**](RequestTypeModel.md) | Specifies a webhook methods to search for | [optional] 

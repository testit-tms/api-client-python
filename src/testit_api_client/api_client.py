...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/7.6.0.post580/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AIServicesAPIApi()
        api_instance.api_v2_external_services_id_ai_models_post  # this is an instance of the class Endpoint
        api_instance.api_v2_external_services_id_ai_models_post()  # this invokes api_instance.api_v2_external_services_id_ai_models_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.api_v2_external_services_id_ai_models_post.callable or self.callable in this class

...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/7.0.1.post530/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.api_v2_attachments_id_delete  # this is an instance of the class Endpoint
        api_instance.api_v2_attachments_id_delete()  # this invokes api_instance.api_v2_attachments_id_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.api_v2_attachments_id_delete.callable or self.callable in this class

...
class WebhooksLogsApi:
    ...
    def api_v2_webhooks_logs_get(
        ...
        _param = self._api_v2_webhooks_logs_get_serialize(
    ...
    @validate_call
    def api_v2_webhooks_logs_get_with_http_info(
        self,
        project_id: Annotated[Optional[StrictStr], Field(description="Project unique ID")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="Amount of items to be skipped (offset)")] = None,
        take: Annotated[Optional[StrictInt], Field(description="Amount of items to be taken (limit)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[WebHookLogModel]]:
        """Get all webhook logs
    ...
    @validate_call
    def api_v2_webhooks_logs_get_without_preload_content(
        self,
        project_id: Annotated[Optional[StrictStr], Field(description="Project unique ID")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="Amount of items to be skipped (offset)")] = None,
        take: Annotated[Optional[StrictInt], Field(description="Amount of items to be taken (limit)")] = None,
    ...
    def _api_v2_webhooks_logs_get_serialize(
        self,
        project_id,
        skip,
        take,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/webhooks/logs',
    ...
    @validate_call
    def api_v2_webhooks_logs_id_delete(
        self,
        id: Annotated[StrictStr, Field(description="Webhook log unique ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._api_v2_webhooks_logs_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_webhooks_logs_id_delete_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Webhook log unique ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_webhooks_logs_id_delete_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Webhook log unique ID")],
        _request_timeout: Union[
            None,
    ...
    def _api_v2_webhooks_logs_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/webhooks/logs/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def api_v2_webhooks_logs_id_get(
        self,
        id: Annotated[StrictStr, Field(description="Webhook log unique ID")],
        _request_timeout: Union[
            None,
        ...
        _param = self._api_v2_webhooks_logs_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_webhooks_logs_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Webhook log unique ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_webhooks_logs_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Webhook log unique ID")],
        _request_timeout: Union[
            None,
    ...
    def _api_v2_webhooks_logs_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,

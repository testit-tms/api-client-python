...
class WebhooksLogsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.api_v2_webhooks_logs_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Bearer or PrivateToken'
    ...
    def api_v2_webhooks_logs_get(
        ...
        **kwargs
        ...
        >>> thread = api.api_v2_webhooks_logs_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_v2_webhooks_logs_get_endpoint.call_with_http_info(**kwargs)
    ...
    def api_v2_webhooks_logs_id_delete(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.api_v2_webhooks_logs_id_delete_endpoint.call_with_http_info(**kwargs)
    ...
    def api_v2_webhooks_logs_id_get(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.api_v2_webhooks_logs_id_get_endpoint.call_with_http_info(**kwargs)

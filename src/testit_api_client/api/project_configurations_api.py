...
class ProjectConfigurationsApi:
    ...
    def get_configurations_by_project_id(
        ...
        _param = self._get_configurations_by_project_id_serialize(
    ...
    @validate_call
    def get_configurations_by_project_id_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_configurations_by_project_id_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        _request_timeout: Union[
            None,
    ...
    def _get_configurations_by_project_id_serialize(
        self,
        project_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectId}/configurations',

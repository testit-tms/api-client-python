...
class ProjectConfigurationsApi:
    ...
    def get_configurations_by_project_id(self, project_id : Annotated[StrictStr, Field(..., description="Project internal (UUID) or global (integer) identifier")], **kwargs) -> List[ConfigurationModel]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_configurations_by_project_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_configurations_by_project_id_with_http_info(project_id, **kwargs)  # noqa: E501
    ...
    def get_configurations_by_project_id_with_http_info(self, project_id : Annotated[StrictStr, Field(..., description="Project internal (UUID) or global (integer) identifier")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_configurations_by_project_id_with_http_info(project_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_configurations_by_project_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']

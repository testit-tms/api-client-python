...
class WorkItemsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.api_v2_work_items_links_urls_search_post_endpoint = _Endpoint(
            settings={
            ...
            params_map={
                'all': [
                    ...
                    'search_field',
                    'search_value',
                    'api_v2_work_items_links_urls_search_post_request',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'search_field': 'query',
                    'search_value': 'query',
                    'api_v2_work_items_links_urls_search_post_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.api_v2_work_items_post_endpoint = _Endpoint(
            settings={
            ...
            params_map={
                'all': [
                    'api_v2_work_items_post_request',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'api_v2_work_items_post_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def api_v2_work_items_links_urls_search_post(
        ...
        **kwargs
        ...
        >>> thread = api.api_v2_work_items_links_urls_search_post(async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            search_field (str): Property name for searching. [optional]
            search_value (str): Value for searching. [optional]
            api_v2_work_items_links_urls_search_post_request (ApiV2WorkItemsLinksUrlsSearchPostRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.api_v2_work_items_links_urls_search_post_endpoint.call_with_http_info(**kwargs)
    ...
    def api_v2_work_items_post(
        ...
        **kwargs
        ...
        >>> thread = api.api_v2_work_items_post(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            api_v2_work_items_post_request (ApiV2WorkItemsPostRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.

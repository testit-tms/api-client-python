...
class ProjectSettingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.api_v2_projects_project_id_settings_autotests_post_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
            ...
            params_map={
                'all': [
                    'project_id',
                    'api_v2_projects_project_id_settings_autotests_post_request',
                ],
                'required': [
                    'project_id',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'project_id': 'path',
                    'api_v2_projects_project_id_settings_autotests_post_request': 'body',
                },
    ...
    def api_v2_projects_project_id_settings_autotests_post(
        ...
        **kwargs
        ...
        >>> thread = api.api_v2_projects_project_id_settings_autotests_post(project_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project_id'] = \
            project_id
        return self.api_v2_projects_project_id_settings_autotests_post_endpoint.call_with_http_info(**kwargs)
    ...
    def get_autotest_project_settings(
        ...
        **kwargs
        ...
        kwargs['project_id'] = \
            project_id
        return self.get_autotest_project_settings_endpoint.call_with_http_info(**kwargs)

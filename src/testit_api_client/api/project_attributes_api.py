...
class ProjectAttributesApi:
    ...
    def create_projects_attribute(
        ...
        custom_attribute_post_model: Optional[CustomAttributePostModel] = None,
        ...
        _param = self._create_projects_attribute_serialize(
            project_id=project_id,
            custom_attribute_post_model=custom_attribute_post_model,
    ...
    @validate_call
    def create_projects_attribute_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        custom_attribute_post_model: Optional[CustomAttributePostModel] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomAttributeModel]:
        """Create project attribute
    ...
    @validate_call
    def create_projects_attribute_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        custom_attribute_post_model: Optional[CustomAttributePostModel] = None,
        _request_timeout: Union[
    ...
    def _create_projects_attribute_serialize(
        self,
        project_id,
        ...
        if custom_attribute_post_model is not None:
            _body_params = custom_attribute_post_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/projects/{projectId}/attributes',
    ...
    def delete_projects_attribute(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        attribute_id: Annotated[StrictStr, Field(description="Project attribute internal (UUID)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_projects_attribute_serialize(
            project_id=project_id,
    ...
    @validate_call
    def delete_projects_attribute_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        attribute_id: Annotated[StrictStr, Field(description="Project attribute internal (UUID)")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_projects_attribute_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        attribute_id: Annotated[StrictStr, Field(description="Project attribute internal (UUID)")],
        _request_timeout: Union[
    ...
    def _delete_projects_attribute_serialize(
        self,
        project_id,
        attribute_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/projects/{projectId}/attributes/{attributeId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_attribute_by_project_id(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        attribute_id: Annotated[StrictStr, Field(description="Project attribute internal (UUID) or global (integer) identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_attribute_by_project_id_serialize(
            project_id=project_id,
            attribute_id=attribute_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_attribute_by_project_id_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        attribute_id: Annotated[StrictStr, Field(description="Project attribute internal (UUID) or global (integer) identifier")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_attribute_by_project_id_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        attribute_id: Annotated[StrictStr, Field(description="Project attribute internal (UUID) or global (integer) identifier")],
        _request_timeout: Union[
    ...
    def _get_attribute_by_project_id_serialize(
        self,
        project_id,
        attribute_id,
        _request_auth,
    ...
    def get_attributes_by_project_id(
        ...
        _param = self._get_attributes_by_project_id_serialize(
            project_id=project_id,
    ...
    @validate_call
    def get_attributes_by_project_id_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        is_deleted: Optional[Any] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_attributes_by_project_id_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        is_deleted: Optional[Any] = None,
        _request_timeout: Union[
    ...
    def _get_attributes_by_project_id_serialize(
        self,
        project_id,
        is_deleted,
        _request_auth,
        ...
        if is_deleted is not None:
            ...
            _query_params.append(('isDeleted', is_deleted.value))
    ...
    def search_attributes_in_project(
        self,
        project_id: Annotated[StrictStr, Field(description="Unique or global project ID")],
        ...
        project_attributes_filter_model: Optional[ProjectAttributesFilterModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._search_attributes_in_project_serialize(
            project_id=project_id,
            skip=skip,
            take=take,
            order_by=order_by,
            ...
            project_attributes_filter_model=project_attributes_filter_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def search_attributes_in_project_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CustomAttributeGetModel]]:
        """Search for attributes used in the project
    ...
    @validate_call
    def search_attributes_in_project_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Unique or global project ID")],
        skip: Annotated[Optional[StrictInt], Field(description="Amount of items to be skipped (offset)")] = None,
        take: Annotated[Optional[StrictInt], Field(description="Amount of items to be taken (limit)")] = None,
    ...
    def _search_attributes_in_project_serialize(
        self,
        project_id,
        skip,
        take,
        ...
        # process the form parameters
        # process the body parameter
        if project_attributes_filter_model is not None:
            _body_params = project_attributes_filter_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/projects/{projectId}/attributes/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_projects_attribute(
        self,
        project_id: Annotated[StrictStr, Field(description="Unique or global project ID")],
        custom_attribute_put_model: Optional[CustomAttributePutModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_projects_attribute_serialize(
            project_id=project_id,
            custom_attribute_put_model=custom_attribute_put_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_projects_attribute_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Unique or global project ID")],
        custom_attribute_put_model: Optional[CustomAttributePutModel] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_projects_attribute_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Unique or global project ID")],
        custom_attribute_put_model: Optional[CustomAttributePutModel] = None,
        _request_timeout: Union[
    ...
    def _update_projects_attribute_serialize(
        self,
        project_id,
        ...
        # process the form parameters
        # process the body parameter
        if custom_attribute_put_model is not None:
            _body_params = custom_attribute_put_model

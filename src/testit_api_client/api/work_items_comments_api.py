...
class WorkItemsCommentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.api_v2_work_items_id_comments_count_get_endpoint = _Endpoint(
            settings={
                'response_type': (int,),
                'auth': [
                    'Bearer or PrivateToken'
    ...
    def api_v2_work_items_id_comments_count_get(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.api_v2_work_items_id_comments_count_get_endpoint.call_with_http_info(**kwargs)

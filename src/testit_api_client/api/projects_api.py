...
class ProjectsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.api_v2_projects_shorts_post_endpoint = _Endpoint(
            ...
            params_map={
                'all': [
                    'api_v2_projects_shorts_post_request',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'api_v2_projects_shorts_post_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def api_v2_projects_shorts_post(
        ...
        **kwargs
        ...
        >>> thread = api.api_v2_projects_shorts_post(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            api_v2_projects_shorts_post_request (ApiV2ProjectsShortsPostRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.api_v2_projects_shorts_post_endpoint.call_with_http_info(**kwargs)
    ...
    def get_test_runs_by_project_id(
        ...
        **kwargs
        ...
        >>> thread = api.get_test_runs_by_project_id(id, not_started, in_progress, stopped, completed, async_req=True)
        >>> result = thread.get()

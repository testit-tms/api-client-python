...
class WebhooksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.api_v2_webhooks_delete_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
            ...
            params_map={
                'all': [
                    'api_v2_webhooks_delete_request',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'api_v2_webhooks_delete_request': 'body',
                },
        ...
        self.api_v2_webhooks_put_endpoint = _Endpoint(
            settings={
            ...
            root_map={
                ...
                'location_map': {
                    'api_v2_webhooks_put_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def api_v2_webhooks_delete(
        ...
        **kwargs
        ...
        >>> thread = api.api_v2_webhooks_delete(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            api_v2_webhooks_delete_request (ApiV2WebhooksDeleteRequest): [optional]
        ...
        return self.api_v2_webhooks_delete_endpoint.call_with_http_info(**kwargs)
    ...
    def api_v2_webhooks_put(
        ...
        **kwargs
        ...
        >>> thread = api.api_v2_webhooks_put(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            api_v2_webhooks_put_request (ApiV2WebhooksPutRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.api_v2_webhooks_put_endpoint.call_with_http_info(**kwargs)

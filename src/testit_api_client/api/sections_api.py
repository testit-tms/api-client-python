...
class SectionsApi:
    ...
    def api_v2_sections_id_patch(
        self,
        id: Annotated[StrictStr, Field(description="Section internal (UUID) identifier")],
        ...
        _param = self._api_v2_sections_id_patch_serialize(
            id=id,
            operation=operation,
    ...
    @validate_call
    def api_v2_sections_id_patch_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Section internal (UUID) identifier")],
        operation: Optional[List[Operation]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def api_v2_sections_id_patch_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Section internal (UUID) identifier")],
        operation: Optional[List[Operation]] = None,
        _request_timeout: Union[
    ...
    def _api_v2_sections_id_patch_serialize(
        self,
        id,
        operation,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v2/sections/{id}',
    ...
    def create_section(
        self,
        section_post_model: Optional[SectionPostModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._create_section_serialize(
            section_post_model=section_post_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_section_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if section_post_model is not None:
            _body_params = section_post_model
    ...
    def get_work_items_by_section_id(
        self,
        id: Annotated[StrictStr, Field(description="Section internal (UUID) identifier")],
        is_deleted: Annotated[Optional[StrictBool], Field(description="Requested section is deleted")] = None,
        tag_names: Annotated[Optional[List[StrictStr]], Field(description="List of work item tags")] = None,
        ...
        _param = self._get_work_items_by_section_id_serialize(
            id=id,
            is_deleted=is_deleted,
            tag_names=tag_names,
    ...
    @validate_call
    def get_work_items_by_section_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Section internal (UUID) identifier")],
        is_deleted: Annotated[Optional[StrictBool], Field(description="Requested section is deleted")] = None,
        tag_names: Annotated[Optional[List[StrictStr]], Field(description="List of work item tags")] = None,
    ...
    @validate_call
    def get_work_items_by_section_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Section internal (UUID) identifier")],
        is_deleted: Annotated[Optional[StrictBool], Field(description="Requested section is deleted")] = None,
        tag_names: Annotated[Optional[List[StrictStr]], Field(description="List of work item tags")] = None,
    ...
    def _get_work_items_by_section_id_serialize(
        self,
        id,
        is_deleted,
        tag_names,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/sections/{id}/workItems',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def move(
        self,
        section_move_model: Optional[SectionMoveModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._move_serialize(
            section_move_model=section_move_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _move_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if section_move_model is not None:
            _body_params = section_move_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/sections/move',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rename(
        self,
        section_rename_model: Optional[SectionRenameModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._rename_serialize(
            section_rename_model=section_rename_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _rename_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if section_rename_model is not None:
            _body_params = section_rename_model
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/sections/rename',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_section(
        self,
        section_put_model: Optional[SectionPutModel] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_section_serialize(
            section_put_model=section_put_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_section_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if section_put_model is not None:
            _body_params = section_put_model

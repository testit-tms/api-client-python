...
class BackgroundJobsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.api_v2_background_jobs_completed_delete_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
        ...
        self.api_v2_background_jobs_get_endpoint = _Endpoint(
            settings={
        ...
        self.api_v2_background_jobs_id_cancel_post_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Bearer or PrivateToken'
        ...
        self.api_v2_background_jobs_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (BackgroundJobGetModel,),
                'auth': [
                    'Bearer or PrivateToken'
        ...
        self.api_v2_background_jobs_id_status_get_endpoint = _Endpoint(
            settings={
        ...
        self.api_v2_background_jobs_search_post_endpoint = _Endpoint(
            settings={
                'response_type': ([BackgroundJobGetModel],),
                'auth': [
                    'Bearer or PrivateToken'
            ...
            params_map={
                'all': [
                    ...
                    'search_field',
                    'search_value',
                    'api_v2_background_jobs_search_post_request',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'search_field': 'query',
                    'search_value': 'query',
                    'api_v2_background_jobs_search_post_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def api_v2_background_jobs_completed_delete(
        ...
        **kwargs
        ...
        return self.api_v2_background_jobs_completed_delete_endpoint.call_with_http_info(**kwargs)

    def api_v2_background_jobs_get(
        self,
        **kwargs
    ):
        """api_v2_background_jobs_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v2_background_jobs_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.api_v2_background_jobs_get_endpoint.call_with_http_info(**kwargs)
    ...
    def api_v2_background_jobs_id_cancel_post(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.api_v2_background_jobs_id_cancel_post_endpoint.call_with_http_info(**kwargs)
    ...
    def api_v2_background_jobs_id_get(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.api_v2_background_jobs_id_get_endpoint.call_with_http_info(**kwargs)
    ...
    def api_v2_background_jobs_id_status_get(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.api_v2_background_jobs_id_status_get_endpoint.call_with_http_info(**kwargs)
    ...
    def api_v2_background_jobs_search_post(
        ...
        **kwargs
        ...
        >>> thread = api.api_v2_background_jobs_search_post(async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            search_field (str): Property name for searching. [optional]
            search_value (str): Value for searching. [optional]
            api_v2_background_jobs_search_post_request (ApiV2BackgroundJobsSearchPostRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.api_v2_background_jobs_search_post_endpoint.call_with_http_info(**kwargs)

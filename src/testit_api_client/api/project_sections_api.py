...
class ProjectSectionsApi:
    ...
    def get_sections_by_project_id(
        ...
        _param = self._get_sections_by_project_id_serialize(
    ...
    @validate_call
    def get_sections_by_project_id_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        skip: Annotated[Optional[StrictInt], Field(description="Amount of items to be skipped (offset)")] = None,
        take: Annotated[Optional[StrictInt], Field(description="Amount of items to be taken (limit)")] = None,
    ...
    @validate_call
    def get_sections_by_project_id_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="Project internal (UUID) or global (integer) identifier")],
        skip: Annotated[Optional[StrictInt], Field(description="Amount of items to be skipped (offset)")] = None,
        take: Annotated[Optional[StrictInt], Field(description="Amount of items to be taken (limit)")] = None,
    ...
    def _get_sections_by_project_id_serialize(
        self,
        project_id,
        skip,
        take,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/projects/{projectId}/sections',

...
def lazy_import():
    ...
    globals()['TestPointShortApiResultStatusModel'] = TestPointShortApiResultStatusModel


class TestPointShortApiResult(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status_model': (TestPointShortApiResultStatusModel,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, is_deleted, status_model, iteration_id, test_suite_id, *args, **kwargs):  # noqa: E501
        """TestPointShortApiResult - a model defined in OpenAPI

        Args:
            id (str): Test point unique internal identifier
            is_deleted (bool): Indicates if the entity is deleted
            status_model (TestPointShortApiResultStatusModel):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, is_deleted, status_model, iteration_id, test_suite_id, *args, **kwargs):  # noqa: E501
        """TestPointShortApiResult - a model defined in OpenAPI

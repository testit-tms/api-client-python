...
class AutoTestProjectSettingsApiResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project_id, is_flaky_auto, flaky_stability_percentage, flaky_test_run_count, rerun_enabled, rerun_attempts_count, *args, **kwargs):  # noqa: E501
        ...
        self.flaky_stability_percentage = flaky_stability_percentage
        self.flaky_test_run_count = flaky_test_run_count
    ...
    @convert_js_args_to_python_args
    def __init__(self, project_id, is_flaky_auto, flaky_stability_percentage, flaky_test_run_count, rerun_enabled, rerun_attempts_count, *args, **kwargs):  # noqa: E501
        """AutoTestProjectSettingsApiResult - a model defined in OpenAPI

...
class AttachmentApiResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, file_id, type, size, created_date, created_by_id, name, *args, **kwargs):  # noqa: E501
        """AttachmentApiResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, file_id, type, size, created_date, created_by_id, name, *args, **kwargs):  # noqa: E501
        """AttachmentApiResult - a model defined in OpenAPI

...
class FilterModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_date, created_by_id, project_id, name, id, is_deleted, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_date, created_by_id, project_id, name, id, is_deleted, *args, **kwargs):  # noqa: E501
        """FilterModel - a model defined in OpenAPI

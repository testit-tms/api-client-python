...
class ProjectShortestModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, is_deleted, global_id, name, type, *args, **kwargs):  # noqa: E501
        """ProjectShortestModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, is_deleted, global_id, name, type, *args, **kwargs):  # noqa: E501
        """ProjectShortestModel - a model defined in OpenAPI

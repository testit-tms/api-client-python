...
class RerunsApiResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, rerun_count, rerun_test_results, *args, **kwargs):  # noqa: E501
        """RerunsApiResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, rerun_count, rerun_test_results, *args, **kwargs):  # noqa: E501
        """RerunsApiResult - a model defined in OpenAPI

...
class TestPointChangeViewModelChangedFieldViewModelOldValue(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TestPointChangeViewModelChangedFieldViewModelOldValue - a model defined in OpenAPI

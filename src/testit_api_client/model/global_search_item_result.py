...
class GlobalSearchItemResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, resource_type, resource_id, name, project_global_id, *args, **kwargs):  # noqa: E501
        """GlobalSearchItemResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, resource_type, resource_id, name, project_global_id, *args, **kwargs):  # noqa: E501
        """GlobalSearchItemResult - a model defined in OpenAPI

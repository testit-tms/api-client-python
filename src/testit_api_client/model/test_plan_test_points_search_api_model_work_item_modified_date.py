...
class TestPlanTestPointsSearchApiModelWorkItemModifiedDate(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TestPlanTestPointsSearchApiModelWorkItemModifiedDate - a model defined in OpenAPI

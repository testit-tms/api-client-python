...
def lazy_import():
    ...
    globals()['TestRunShortApiResultStatistics'] = TestRunShortApiResultStatistics
    globals()['TestRunShortApiResultStatus'] = TestRunShortApiResultStatus
    globals()['TestRunState'] = TestRunState


class TestRunShortApiResult(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status': (TestRunShortApiResultStatus,),  # noqa: E501
    ...
    def _from_openapi_data(cls, id, name, state, status, created_date, created_by_id, is_deleted, auto_tests_count, statistics, test_results_configurations, tags, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            state (TestRunState):
            status (TestRunShortApiResultStatus):
        ...
        Keyword Args:
            ...
            completed_date (datetime, none_type): Completion date of the test run. [optional]  # noqa: E501

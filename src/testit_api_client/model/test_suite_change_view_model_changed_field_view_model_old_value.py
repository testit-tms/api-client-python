...
class TestSuiteChangeViewModelChangedFieldViewModelOldValue(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TestSuiteChangeViewModelChangedFieldViewModelOldValue - a model defined in OpenAPI

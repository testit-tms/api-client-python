...
def lazy_import():
    ...
    globals()['TestPlanStatus'] = TestPlanStatus
    globals()['TestPlanTagApiResult'] = TestPlanTagApiResult


class TestPlanApiResult(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'status': (TestPlanStatus,),  # noqa: E501
            'tags': ([TestPlanTagApiResult],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, status, tags, global_id, attributes, created_by_id, is_deleted, *args, **kwargs):  # noqa: E501
        """TestPlanApiResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, status, tags, global_id, attributes, created_by_id, is_deleted, *args, **kwargs):  # noqa: E501
        """TestPlanApiResult - a model defined in OpenAPI

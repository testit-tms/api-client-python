...
def lazy_import():
    ...
    globals()['UpdateTestPlanApiModel'] = UpdateTestPlanApiModel


class UpdateTestPlanRequest(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateTestPlanRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            locked_by_id (str, none_type): User who locked test plan modification internal identifier. [optional]  # noqa: E501
            ...
            build (str, none_type): Build of the application on which test plan is executed. [optional]  # noqa: E501
            product_name (str, none_type): Name of the testing product. [optional]  # noqa: E501
            has_automatic_duration_timer (bool, none_type): Boolean flag defines if test plan has automatic duration timer. [optional]  # noqa: E501
            attributes ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Key value pair of test plan custom attributes. [optional]  # noqa: E501

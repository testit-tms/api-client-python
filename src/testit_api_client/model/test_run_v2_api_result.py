...
def lazy_import():
    ...
    globals()['NamedEntityApiModel'] = NamedEntityApiModel
...
class TestRunV2ApiResult(ModelNormal):
    ...
    def _from_openapi_data(cls, id, name, state_name, status, project_id, created_date, created_by_id, attachments, links, webhooks, run_count, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            custom_parameters ({str: (str,)}, none_type): Customers test run parameters. [optional]  # noqa: E501
        """

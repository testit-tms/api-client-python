...
class ExternalServicesMetadataApiResult(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ExternalServiceMetadataApiResult],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ExternalServicesMetadataApiResult - a model defined in OpenAPI

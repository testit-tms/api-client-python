...
class SharedStepReferenceSectionsQueryFilterModelCreatedDate(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SharedStepReferenceSectionsQueryFilterModelCreatedDate - a model defined in OpenAPI

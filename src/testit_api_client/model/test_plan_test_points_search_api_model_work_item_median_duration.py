...
class TestPlanTestPointsSearchApiModelWorkItemMedianDuration(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TestPlanTestPointsSearchApiModelWorkItemMedianDuration - a model defined in OpenAPI

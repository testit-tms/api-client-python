...
class ProjectShortApiResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, is_deleted, global_id, name, type, is_favorite, *args, **kwargs):  # noqa: E501
        """ProjectShortApiResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, is_deleted, global_id, name, type, is_favorite, *args, **kwargs):  # noqa: E501
        """ProjectShortApiResult - a model defined in OpenAPI

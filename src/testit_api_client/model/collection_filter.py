...
class CollectionFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, operator, filter, field, *args, **kwargs):  # noqa: E501
        """CollectionFilter - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, operator, filter, *args, **kwargs):  # noqa: E501
        """CollectionFilter - a model defined in OpenAPI

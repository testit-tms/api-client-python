...
class TestResultChangeViewModelChangedFieldViewModelOldValue(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TestResultChangeViewModelChangedFieldViewModelOldValue - a model defined in OpenAPI

...
class TagApiResult(ModelNormal):
    ...
    def _from_openapi_data(cls, id, name, created_date, created_by_id, *args, **kwargs):  # noqa: E501
        """TagApiResult - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            modified_date (datetime, none_type): Latest modification date of the tag. [optional]  # noqa: E501
            modified_by_id (str, none_type): ID of the user who last modified the tag. [optional]  # noqa: E501
        """

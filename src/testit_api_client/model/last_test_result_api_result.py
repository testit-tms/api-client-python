...
class LastTestResultApiResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, test_run_id, links, attachments, *args, **kwargs):  # noqa: E501
        """LastTestResultApiResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, test_run_id, links, attachments, *args, **kwargs):  # noqa: E501
        """LastTestResultApiResult - a model defined in OpenAPI

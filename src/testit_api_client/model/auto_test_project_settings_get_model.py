...
class AutoTestProjectSettingsGetModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project_id, rerun_enabled, rerun_attempts_count, *args, **kwargs):  # noqa: E501
        """AutoTestProjectSettingsGetModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, project_id, rerun_enabled, rerun_attempts_count, *args, **kwargs):  # noqa: E501
        """AutoTestProjectSettingsGetModel - a model defined in OpenAPI

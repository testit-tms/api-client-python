...
class ApiV2TestSuitesPostRequest1(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApiV2TestSuitesPostRequest1 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (bool, date, datetime, dict, float, int, list, str, none_type): Type of the test suite. [optional]  # noqa: E501

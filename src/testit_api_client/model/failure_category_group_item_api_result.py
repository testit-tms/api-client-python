...
def lazy_import():
    ...
    globals()['FailureCategoryItemApiResult'] = FailureCategoryItemApiResult


class FailureCategoryGroupItemApiResult(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([FailureCategoryItemApiResult],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """FailureCategoryGroupItemApiResult - a model defined in OpenAPI

...
class CreateUserApiModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user_name, first_name, last_name, display_name, email, *args, **kwargs):  # noqa: E501
        """CreateUserApiModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user_name, first_name, last_name, display_name, email, *args, **kwargs):  # noqa: E501
        """CreateUserApiModel - a model defined in OpenAPI

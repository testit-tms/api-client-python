...
class CompositeFilter(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, filters, operator, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, filters, operator, *args, **kwargs):  # noqa: E501
        """CompositeFilter - a model defined in OpenAPI

...
class ExternalServiceMetadataApiResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, code, icon_url, category, *args, **kwargs):  # noqa: E501
        """ExternalServiceMetadataApiResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, code, icon_url, category, *args, **kwargs):  # noqa: E501
        """ExternalServiceMetadataApiResult - a model defined in OpenAPI

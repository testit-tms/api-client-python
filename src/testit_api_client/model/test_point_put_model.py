...
def lazy_import():
    ...
    globals()['TestPointPutModelStatusModel'] = TestPointPutModelStatusModel


class TestPointPutModel(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status_model': (TestPointPutModelStatusModel,),  # noqa: E501
            'id': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, iteration_id, test_suite_id, status_model, id, is_deleted, *args, **kwargs):  # noqa: E501
        """TestPointPutModel - a model defined in OpenAPI

        Args:
            iteration_id (str):
            test_suite_id (str):
            status_model (TestPointPutModelStatusModel):
    ...
    @convert_js_args_to_python_args
    def __init__(self, iteration_id, test_suite_id, status_model, id, is_deleted, *args, **kwargs):  # noqa: E501
        """TestPointPutModel - a model defined in OpenAPI

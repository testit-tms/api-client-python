...
class WorkItemPreviewApiModel(BaseModel):
    ...
    __properties = ["name", "action", "expected"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemPreviewApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemPreviewApiModel:
        """Create an instance of WorkItemPreviewApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemPreviewApiModel.parse_obj(obj)

        _obj = WorkItemPreviewApiModel.parse_obj({
            "name": obj.get("name"),

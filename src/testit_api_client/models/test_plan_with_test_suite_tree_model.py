...
class TestPlanWithTestSuiteTreeModel(BaseModel):
    ...
    """
    test_suites: conlist(TestSuiteWithChildrenModel) = Field(default=..., alias="testSuites")
    ...
    __properties = ["testSuites", "status", "startedOn", "completedOn", "createdDate", "modifiedDate", "createdById", "modifiedById", "globalId", "isDeleted", "lockedDate", "id", "lockedById", "tags", "name", "startDate", "endDate", "description", "build", "projectId", "productName", "hasAutomaticDurationTimer", "attributes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPlanWithTestSuiteTreeModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPlanWithTestSuiteTreeModel:
        """Create an instance of TestPlanWithTestSuiteTreeModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPlanWithTestSuiteTreeModel.parse_obj(obj)

        _obj = TestPlanWithTestSuiteTreeModel.parse_obj({
            "test_suites": [TestSuiteWithChildrenModel.from_dict(_item) for _item in obj.get("testSuites")] if obj.get("testSuites") is not None else None,

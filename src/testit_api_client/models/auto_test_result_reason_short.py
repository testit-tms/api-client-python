...
class AutoTestResultReasonShort(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoTestResultReasonShort:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoTestResultReasonShort:
        """Create an instance of AutoTestResultReasonShort from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutoTestResultReasonShort.parse_obj(obj)

        _obj = AutoTestResultReasonShort.parse_obj({

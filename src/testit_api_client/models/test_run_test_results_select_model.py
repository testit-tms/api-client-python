...
class TestRunTestResultsSelectModel(BaseModel):
    ...
    test_result_ids_extraction_model: Optional[GuidExtractionModel] = Field(default=None, description="Rules to include and exclude certain entities in result", alias="testResultIdsExtractionModel")
    __properties: ClassVar[List[str]] = ["filter", "testResultIdsExtractionModel"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.test_result_ids_extraction_model is None and "test_result_ids_extraction_model" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": TestResultsLocalFilterModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "testResultIdsExtractionModel": GuidExtractionModel.from_dict(obj["testResultIdsExtractionModel"]) if obj.get("testResultIdsExtractionModel") is not None else None
        })
        return _obj

...
class WorkItemLocalSelectModel(BaseModel):
    ...
    extraction_model: Optional[WorkItemExtractionModel] = Field(default=None, description="Rules for different level entities inclusion/exclusion", alias="extractionModel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": WorkItemLocalFilterModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "extractionModel": WorkItemExtractionModel.from_dict(obj["extractionModel"]) if obj.get("extractionModel") is not None else None
        })
        return _obj

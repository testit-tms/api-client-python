...
class WorkItemSelectApiModel(BaseModel):
    """
    WorkItemSelectApiModel
    """
    filter: WorkItemFilterApiModel = Field(...)
    extraction_model: Optional[WorkItemExtractionApiModel] = Field(default=None, alias="extractionModel")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemSelectApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemSelectApiModel:
        """Create an instance of WorkItemSelectApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemSelectApiModel.parse_obj(obj)

        _obj = WorkItemSelectApiModel.parse_obj({
            "filter": WorkItemFilterApiModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": WorkItemExtractionApiModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

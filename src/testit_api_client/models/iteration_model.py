...
class IterationModel(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    parameters: Optional[List[ParameterShortModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "parameters": [ParameterShortModel.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None
        })
        return _obj

...
class StepResultModel(BaseModel):
    ...
    shared_step_results: Optional[List[SharedStepResultModel]] = Field(default=None, alias="sharedStepResults")
    comment: Optional[StepCommentModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sharedStepResults": [SharedStepResultModel.from_dict(_item) for _item in obj["sharedStepResults"]] if obj.get("sharedStepResults") is not None else None,
            "comment": StepCommentModel.from_dict(obj["comment"]) if obj.get("comment") is not None else None
        })
        return _obj

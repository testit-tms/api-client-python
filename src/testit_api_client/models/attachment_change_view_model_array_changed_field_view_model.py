...
class AttachmentChangeViewModelArrayChangedFieldViewModel(BaseModel):
    """
    AttachmentChangeViewModelArrayChangedFieldViewModel
    """
    old_value: Optional[conlist(AttachmentChangeViewModel)] = Field(default=None, alias="oldValue")
    new_value: Optional[conlist(AttachmentChangeViewModel)] = Field(default=None, alias="newValue")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttachmentChangeViewModelArrayChangedFieldViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttachmentChangeViewModelArrayChangedFieldViewModel:
        """Create an instance of AttachmentChangeViewModelArrayChangedFieldViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttachmentChangeViewModelArrayChangedFieldViewModel.parse_obj(obj)

        _obj = AttachmentChangeViewModelArrayChangedFieldViewModel.parse_obj({
            "old_value": [AttachmentChangeViewModel.from_dict(_item) for _item in obj.get("oldValue")] if obj.get("oldValue") is not None else None,
            "new_value": [AttachmentChangeViewModel.from_dict(_item) for _item in obj.get("newValue")] if obj.get("newValue") is not None else None
        })
        return _obj

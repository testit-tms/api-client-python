...
class AttachmentChangeViewModelArrayChangedFieldViewModel(BaseModel):
    ...
    """ # noqa: E501
    old_value: Optional[List[AttachmentChangeViewModel]] = Field(default=None, alias="oldValue")
    new_value: Optional[List[AttachmentChangeViewModel]] = Field(default=None, alias="newValue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oldValue": [AttachmentChangeViewModel.from_dict(_item) for _item in obj["oldValue"]] if obj.get("oldValue") is not None else None,
            "newValue": [AttachmentChangeViewModel.from_dict(_item) for _item in obj["newValue"]] if obj.get("newValue") is not None else None
        })
        return _obj

...
class BooleanNullableChangedFieldViewModel(BaseModel):
    """
    BooleanNullableChangedFieldViewModel
    """
    old_value: Optional[StrictBool] = Field(default=None, alias="oldValue")
    new_value: Optional[StrictBool] = Field(default=None, alias="newValue")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BooleanNullableChangedFieldViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BooleanNullableChangedFieldViewModel:
        """Create an instance of BooleanNullableChangedFieldViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BooleanNullableChangedFieldViewModel.parse_obj(obj)

        _obj = BooleanNullableChangedFieldViewModel.parse_obj({

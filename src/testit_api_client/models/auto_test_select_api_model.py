...
class AutoTestSelectApiModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoTestSelectApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoTestSelectApiModel:
        """Create an instance of AutoTestSelectApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutoTestSelectApiModel.parse_obj(obj)

        _obj = AutoTestSelectApiModel.parse_obj({
            "filter": AutoTestFilterApiModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": AutoTestExtractionApiModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

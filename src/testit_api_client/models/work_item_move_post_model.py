...
class WorkItemMovePostModel(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    new_section_id: StrictStr = Field(alias="newSectionId")
    ...
    __properties: ClassVar[List[str]] = ["id", "newSectionId", "oldSectionId", "nextWorkItemId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.old_section_id is None and "old_section_id" in self.model_fields_set:
            _dict['oldSectionId'] = None

        # set to None if next_work_item_id (nullable) is None
        # and model_fields_set contains the field
        if self.next_work_item_id is None and "next_work_item_id" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "newSectionId": obj.get("newSectionId"),
            "oldSectionId": obj.get("oldSectionId"),
            "nextWorkItemId": obj.get("nextWorkItemId")
        })
        return _obj

...
class TestPlanExtractionModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPlanExtractionModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPlanExtractionModel:
        """Create an instance of TestPlanExtractionModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPlanExtractionModel.parse_obj(obj)

        _obj = TestPlanExtractionModel.parse_obj({

...
class TestPointSelectModel(BaseModel):
    """
    TestPointSelectModel
    """
    filter: Optional[TestPointFilterModel] = None
    extraction_model: Optional[TestPointsExtractionModel] = Field(default=None, alias="extractionModel")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPointSelectModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPointSelectModel:
        """Create an instance of TestPointSelectModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPointSelectModel.parse_obj(obj)

        _obj = TestPointSelectModel.parse_obj({
            "filter": TestPointFilterModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": TestPointsExtractionModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

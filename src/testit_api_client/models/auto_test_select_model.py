...
class AutoTestSelectModel(BaseModel):
    """
    AutoTestSelectModel
    """
    filter: AutoTestFilterModel = Field(...)
    extraction_model: Optional[AutoTestsExtractionModel] = Field(default=None, alias="extractionModel")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoTestSelectModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoTestSelectModel:
        """Create an instance of AutoTestSelectModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutoTestSelectModel.parse_obj(obj)

        _obj = AutoTestSelectModel.parse_obj({
            "filter": AutoTestFilterModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": AutoTestsExtractionModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

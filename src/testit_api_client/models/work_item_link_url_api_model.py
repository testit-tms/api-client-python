...
class WorkItemLinkUrlApiModel(BaseModel):
    ...
    extraction_model: WorkItemLinkExtractionApiModel = Field(alias="extractionModel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": WorkItemLinkUrlFilterApiModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "extractionModel": WorkItemLinkExtractionApiModel.from_dict(obj["extractionModel"]) if obj.get("extractionModel") is not None else None
        })
        return _obj

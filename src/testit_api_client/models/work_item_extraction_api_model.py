...
class WorkItemExtractionApiModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemExtractionApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemExtractionApiModel:
        """Create an instance of WorkItemExtractionApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemExtractionApiModel.parse_obj(obj)

        _obj = WorkItemExtractionApiModel.parse_obj({

...
class WorkItemExtractionApiModel(BaseModel):
    """
    ...
    section_ids: Optional[GuidExtractionModel] = Field(default=None, description="Extraction parameters for sections", alias="sectionIds")
    __properties: ClassVar[List[str]] = ["projectIds", "ids", "sectionIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sectionIds": GuidExtractionModel.from_dict(obj["sectionIds"]) if obj.get("sectionIds") is not None else None
        })
        return _obj

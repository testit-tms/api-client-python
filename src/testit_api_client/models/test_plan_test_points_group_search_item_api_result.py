...
class TestPlanTestPointsGroupSearchItemApiResult(BaseModel):
    ...
    """ # noqa: E501
    group: Optional[TestPlanTestPointsGroupApiResult]
    items: List[TestPlanTestPointsSearchApiResult]
    __properties: ClassVar[List[str]] = ["group", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": TestPlanTestPointsGroupApiResult.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "items": [TestPlanTestPointsSearchApiResult.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj

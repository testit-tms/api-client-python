...
class TestPlanTestPointsExtractionApiModel(BaseModel):
    """
    TestPlanTestPointsExtractionApiModel
    """
    ids: Optional[GuidExtractionModel] = Field(default=None, description="Extraction parameters for test points")
    __properties = ["ids"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPlanTestPointsExtractionApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPlanTestPointsExtractionApiModel:
        """Create an instance of TestPlanTestPointsExtractionApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPlanTestPointsExtractionApiModel.parse_obj(obj)

        _obj = TestPlanTestPointsExtractionApiModel.parse_obj({

...
class RerunTestResultModel(BaseModel):
    """
    ...
    __properties = ["id", "outcome", "runNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RerunTestResultModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RerunTestResultModel:
        """Create an instance of RerunTestResultModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RerunTestResultModel.parse_obj(obj)

        _obj = RerunTestResultModel.parse_obj({
            "id": obj.get("id"),

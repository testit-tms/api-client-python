...
class WorkItemFilterApiModel(BaseModel):
    ...
    source_types: Optional[List[WorkItemSourceTypeModel]] = Field(default=None, description="Source type of work item (manual creation or AI generated)", alias="sourceTypes")
    ...
    __properties: ClassVar[List[str]] = ["nameOrId", "includeIds", "excludeIds", "projectIds", "name", "ids", "globalIds", "attributes", "isDeleted", "sectionIds", "createdByIds", "modifiedByIds", "states", "priorities", "sourceTypes", "types", "createdDate", "modifiedDate", "duration", "medianDuration", "isAutomated", "tags", "autoTestIds", "workItemVersionIds", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": WorkItemLinkFilterApiModel.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj

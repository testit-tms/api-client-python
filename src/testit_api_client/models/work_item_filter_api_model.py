...
class WorkItemFilterApiModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nameOrId", "includeIds", "excludeIds", "projectIds", "name", "ids", "globalIds", "attributes", "isDeleted", "sectionIds", "createdByIds", "modifiedByIds", "states", "priorities", "types", "createdDate", "modifiedDate", "duration", "medianDuration", "isAutomated", "tags", "autoTestIds", "workItemVersionIds", "links"]

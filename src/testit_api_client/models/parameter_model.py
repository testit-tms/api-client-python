...
class ParameterModel(BaseModel):
    ...
    parameter_key_id: StrictStr = Field(alias="parameterKeyId")
    id: StrictStr
    value: Annotated[str, Field(min_length=0, strict=True, max_length=1500)] = Field(description="Value of the parameter")
    name: Annotated[str, Field(min_length=0, strict=True, max_length=255)] = Field(description="Key of the parameter")
    __properties: ClassVar[List[str]] = ["createdDate", "modifiedDate", "createdById", "modifiedById", "isDeleted", "parameterKeyId", "id", "value", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameterKeyId": obj.get("parameterKeyId"),
            "id": obj.get("id"),
            "value": obj.get("value"),
            "name": obj.get("name")
        })

...
class TagExtractionModel(BaseModel):
    """
    TagExtractionModel
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagExtractionModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagExtractionModel:
        """Create an instance of TagExtractionModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagExtractionModel.parse_obj(obj)

        _obj = TagExtractionModel.parse_obj({

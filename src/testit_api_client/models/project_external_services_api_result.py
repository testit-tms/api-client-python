...
class ProjectExternalServicesApiResult(BaseModel):
    ...
    """ # noqa: E501
    data: List[ProjectExternalServiceApiResult] = Field(description="External services associated with a project")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ProjectExternalServiceApiResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

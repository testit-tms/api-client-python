...
class WorkItemShortApiResult(BaseModel):
    ...
    name: StrictStr = Field(description="Work Item name")
    entity_type_name: StrictStr = Field(description="Work Item type. Possible values: CheckLists, SharedSteps, TestCases", alias="entityTypeName")
    ...
    section_name: StrictStr = Field(description="Section name of Work Item", alias="sectionName")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": [LinkShortApiResult.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None
        })
        return _obj

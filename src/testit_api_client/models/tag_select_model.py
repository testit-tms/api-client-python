...
class TagSelectModel(BaseModel):
    """
    TagSelectModel
    """
    filter: Optional[TagsFilterModel] = None
    extraction_model: Optional[TagExtractionModel] = Field(default=None, alias="extractionModel")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagSelectModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagSelectModel:
        """Create an instance of TagSelectModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagSelectModel.parse_obj(obj)

        _obj = TagSelectModel.parse_obj({
            "filter": TagsFilterModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": TagExtractionModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

...
class TestPlanGroupByTesterAndStatus(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPlanGroupByTesterAndStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPlanGroupByTesterAndStatus:
        """Create an instance of TestPlanGroupByTesterAndStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPlanGroupByTesterAndStatus.parse_obj(obj)

        _obj = TestPlanGroupByTesterAndStatus.parse_obj({

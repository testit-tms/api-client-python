...
class WorkItemLinkChangeViewModelArrayChangedFieldViewModel(BaseModel):
    """
    WorkItemLinkChangeViewModelArrayChangedFieldViewModel
    """
    old_value: Optional[conlist(WorkItemLinkChangeViewModel)] = Field(default=None, alias="oldValue")
    new_value: Optional[conlist(WorkItemLinkChangeViewModel)] = Field(default=None, alias="newValue")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemLinkChangeViewModelArrayChangedFieldViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemLinkChangeViewModelArrayChangedFieldViewModel:
        """Create an instance of WorkItemLinkChangeViewModelArrayChangedFieldViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemLinkChangeViewModelArrayChangedFieldViewModel.parse_obj(obj)

        _obj = WorkItemLinkChangeViewModelArrayChangedFieldViewModel.parse_obj({
            "old_value": [WorkItemLinkChangeViewModel.from_dict(_item) for _item in obj.get("oldValue")] if obj.get("oldValue") is not None else None,
            "new_value": [WorkItemLinkChangeViewModel.from_dict(_item) for _item in obj.get("newValue")] if obj.get("newValue") is not None else None
        })
        return _obj

...
class TestResultsExtractionApiModel(BaseModel):
    """
    TestResultsExtractionApiModel
    """
    ids: Optional[GuidExtractionModel] = Field(default=None, description="Set of extracted test result IDs")
    __properties = ["ids"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultsExtractionApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResultsExtractionApiModel:
        """Create an instance of TestResultsExtractionApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultsExtractionApiModel.parse_obj(obj)

        _obj = TestResultsExtractionApiModel.parse_obj({

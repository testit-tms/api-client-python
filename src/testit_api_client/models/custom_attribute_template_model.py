...
class CustomAttributeTemplateModel(BaseModel):
    """
    ...
    __properties = ["id", "isDeleted", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomAttributeTemplateModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomAttributeTemplateModel:
        """Create an instance of CustomAttributeTemplateModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomAttributeTemplateModel.parse_obj(obj)

        _obj = CustomAttributeTemplateModel.parse_obj({
            "id": obj.get("id"),

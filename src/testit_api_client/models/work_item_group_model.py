...
class WorkItemGroupModel(BaseModel):
    ...
    size: StrictInt
    work_items: List[WorkItemShortModel] = Field(alias="workItems")
    __properties: ClassVar[List[str]] = ["key", "size", "workItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "size": obj.get("size"),
            "workItems": [WorkItemShortModel.from_dict(_item) for _item in obj["workItems"]] if obj.get("workItems") is not None else None
        })
        return _obj

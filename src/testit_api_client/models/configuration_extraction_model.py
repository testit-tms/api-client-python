...
class ConfigurationExtractionModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigurationExtractionModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigurationExtractionModel:
        """Create an instance of ConfigurationExtractionModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigurationExtractionModel.parse_obj(obj)

        _obj = ConfigurationExtractionModel.parse_obj({

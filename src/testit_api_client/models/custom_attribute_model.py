...
class CustomAttributeModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomAttributeModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomAttributeModel:
        """Create an instance of CustomAttributeModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomAttributeModel.parse_obj(obj)

        _obj = CustomAttributeModel.parse_obj({
            "id": obj.get("id"),

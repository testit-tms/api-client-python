...
class AttachmentUpdateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttachmentUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttachmentUpdateRequest:
        """Create an instance of AttachmentUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttachmentUpdateRequest.parse_obj(obj)

        _obj = AttachmentUpdateRequest.parse_obj({
            "id": obj.get("id")
        })
        return _obj

...
class AutoTestChangeViewModel(BaseModel):
    """
    ...
    __properties = ["id", "projectId", "externalId", "globalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoTestChangeViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoTestChangeViewModel:
        """Create an instance of AutoTestChangeViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutoTestChangeViewModel.parse_obj(obj)

        _obj = AutoTestChangeViewModel.parse_obj({
            "id": obj.get("id"),

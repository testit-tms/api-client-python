...
class TestResultApiResult(BaseModel):
    ...
    auto_test_step_results: Optional[conlist(AutoTestStepResultsApiResult)] = Field(default=None, alias="autoTestStepResults")
    setup_results: Optional[conlist(AutoTestStepResultsApiResult)] = Field(default=None, alias="setupResults")
    teardown_results: Optional[conlist(AutoTestStepResultsApiResult)] = Field(default=None, alias="teardownResults")
    ...
    failure_classes: conlist(TestResultFailureClassApiResult) = Field(default=..., alias="failureClasses")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultApiResult:
    ...
    def to_dict(self):
        ...
        if self.failure_classes:
            for _item in self.failure_classes:
                if _item:
                    _items.append(_item.to_dict())
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResultApiResult:
        """Create an instance of TestResultApiResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultApiResult.parse_obj(obj)

        _obj = TestResultApiResult.parse_obj({
            "id": obj.get("id"),
            ...
            "auto_test": AutoTestApiResult.from_dict(obj.get("autoTest")) if obj.get("autoTest") is not None else None,
            "auto_test_step_results": [AutoTestStepResultsApiResult.from_dict(_item) for _item in obj.get("autoTestStepResults")] if obj.get("autoTestStepResults") is not None else None,
            "setup_results": [AutoTestStepResultsApiResult.from_dict(_item) for _item in obj.get("setupResults")] if obj.get("setupResults") is not None else None,
            "teardown_results": [AutoTestStepResultsApiResult.from_dict(_item) for _item in obj.get("teardownResults")] if obj.get("teardownResults") is not None else None,
            ...
            "failure_classes": [TestResultFailureClassApiResult.from_dict(_item) for _item in obj.get("failureClasses")] if obj.get("failureClasses") is not None else None,

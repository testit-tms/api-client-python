...
class WorkItemLocalFilterModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemLocalFilterModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemLocalFilterModel:
        """Create an instance of WorkItemLocalFilterModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemLocalFilterModel.parse_obj(obj)

        _obj = WorkItemLocalFilterModel.parse_obj({
            "name": obj.get("name"),
            "ids": obj.get("ids"),

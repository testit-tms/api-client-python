...
class TestPlanTestPointsSearchApiModel(BaseModel):
    ...
    __properties = ["testSuiteIds", "workItemGlobalIds", "workItemMedianDuration", "statuses", "statusCodes", "priorities", "isAutomated", "name", "configurationIds", "testerIds", "duration", "sectionIds", "createdDate", "createdByIds", "modifiedDate", "modifiedByIds", "tags", "attributes", "workItemCreatedDate", "workItemCreatedByIds", "workItemModifiedDate", "workItemModifiedByIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPlanTestPointsSearchApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPlanTestPointsSearchApiModel:
        """Create an instance of TestPlanTestPointsSearchApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPlanTestPointsSearchApiModel.parse_obj(obj)

        _obj = TestPlanTestPointsSearchApiModel.parse_obj({

...
class TestResultResponse(BaseModel):
    ...
    auto_test_step_results: Optional[List[AutoTestStepResult]] = Field(default=None, alias="autoTestStepResults")
    setup_results: Optional[List[AutoTestStepResult]] = Field(default=None, alias="setupResults")
    teardown_results: Optional[List[AutoTestStepResult]] = Field(default=None, alias="teardownResults")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "modifiedDate", "createdById", "modifiedById", "stepComments", "failureClassIds", "outcome", "status", "comment", "links", "stepResults", "attachments", "autoTestId", "configurationId", "startedOn", "completedOn", "durationInMs", "traces", "failureType", "message", "runByUserId", "stoppedByUserId", "testPointId", "testRunId", "testPoint", "autoTest", "autoTestStepResults", "setupResults", "teardownResults", "workItemVersionId", "workItemVersionNumber", "parameters", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testPoint": TestPoint.from_dict(obj["testPoint"]) if obj.get("testPoint") is not None else None,
            "autoTest": AutoTest.from_dict(obj["autoTest"]) if obj.get("autoTest") is not None else None,
            "autoTestStepResults": [AutoTestStepResult.from_dict(_item) for _item in obj["autoTestStepResults"]] if obj.get("autoTestStepResults") is not None else None,
            "setupResults": [AutoTestStepResult.from_dict(_item) for _item in obj["setupResults"]] if obj.get("setupResults") is not None else None,
            "teardownResults": [AutoTestStepResult.from_dict(_item) for _item in obj["teardownResults"]] if obj.get("teardownResults") is not None else None,

...
class ParameterPutModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParameterPutModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParameterPutModel:
        """Create an instance of ParameterPutModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParameterPutModel.parse_obj(obj)

        _obj = ParameterPutModel.parse_obj({
            "id": obj.get("id"),
            "value": obj.get("value"),
            "name": obj.get("name")
        })

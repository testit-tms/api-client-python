...
class AutoTestPostModel(BaseModel):
    ...
    AutoTestPostModel
    """ # noqa: E501
    work_item_ids_for_link_with_auto_test: Optional[List[StrictStr]] = Field(default=None, description="Specifies the IDs of work items to link your autotest to. You can specify several IDs.", alias="workItemIdsForLinkWithAutoTest")
    should_create_work_item: Optional[StrictBool] = Field(default=None, description="Creates a test case linked to the autotest.", alias="shouldCreateWorkItem")
    ...
    links: Optional[List[LinkPostModel]] = Field(default=None, description="Collection of the autotest links")
    ...
    __properties: ClassVar[List[str]] = ["workItemIdsForLinkWithAutoTest", "shouldCreateWorkItem", "attributes", "externalId", "links", "projectId", "name", "namespace", "classname", "steps", "setup", "teardown", "title", "description", "labels", "isFlaky", "externalKey"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.should_create_work_item is None and "should_create_work_item" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shouldCreateWorkItem": obj.get("shouldCreateWorkItem"),

...
class TagsExtractionApiModel(BaseModel):
    """
    TagsExtractionApiModel
    """
    ids: Optional[GuidExtractionModel] = Field(default=None, description="Specifies tags unique ID's to search for")
    __properties = ["ids"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagsExtractionApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagsExtractionApiModel:
        """Create an instance of TagsExtractionApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagsExtractionApiModel.parse_obj(obj)

        _obj = TagsExtractionApiModel.parse_obj({

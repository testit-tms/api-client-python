...
class EnableProjectExternalServiceApiModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnableProjectExternalServiceApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnableProjectExternalServiceApiModel:
        """Create an instance of EnableProjectExternalServiceApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnableProjectExternalServiceApiModel.parse_obj(obj)

        _obj = EnableProjectExternalServiceApiModel.parse_obj({

...
class TestPointChangeViewModelChangedFieldViewModel(BaseModel):
    """
    TestPointChangeViewModelChangedFieldViewModel
    """
    old_value: Optional[TestPointChangeViewModel] = Field(default=None, alias="oldValue")
    new_value: Optional[TestPointChangeViewModel] = Field(default=None, alias="newValue")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPointChangeViewModelChangedFieldViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPointChangeViewModelChangedFieldViewModel:
        """Create an instance of TestPointChangeViewModelChangedFieldViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPointChangeViewModelChangedFieldViewModel.parse_obj(obj)

        _obj = TestPointChangeViewModelChangedFieldViewModel.parse_obj({
            "old_value": TestPointChangeViewModel.from_dict(obj.get("oldValue")) if obj.get("oldValue") is not None else None,
            "new_value": TestPointChangeViewModel.from_dict(obj.get("newValue")) if obj.get("newValue") is not None else None
        })
        return _obj

...
class WorkItemLikeModel(BaseModel):
    ...
    __properties = ["workItemId", "createdDate", "modifiedDate", "createdById", "modifiedById", "id", "isDeleted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemLikeModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemLikeModel:
        """Create an instance of WorkItemLikeModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemLikeModel.parse_obj(obj)

        _obj = WorkItemLikeModel.parse_obj({

...
class CreateLinkApiModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateLinkApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateLinkApiModel:
        """Create an instance of CreateLinkApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateLinkApiModel.parse_obj(obj)

        _obj = CreateLinkApiModel.parse_obj({
            "title": obj.get("title"),
            "url": obj.get("url"),

...
class WebHookTestModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebHookTestModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebHookTestModel:
        """Create an instance of WebHookTestModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebHookTestModel.parse_obj(obj)

        _obj = WebHookTestModel.parse_obj({

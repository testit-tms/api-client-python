...
class PeriodViewModel(BaseModel):
    """
    PeriodViewModel
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PeriodViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PeriodViewModel:
        """Create an instance of PeriodViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PeriodViewModel.parse_obj(obj)

        _obj = PeriodViewModel.parse_obj({

...
class AutoTestExtractionApiModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoTestExtractionApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoTestExtractionApiModel:
        """Create an instance of AutoTestExtractionApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutoTestExtractionApiModel.parse_obj(obj)

        _obj = AutoTestExtractionApiModel.parse_obj({

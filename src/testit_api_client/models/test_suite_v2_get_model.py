...
class TestSuiteV2GetModel(BaseModel):
    ...
    __properties = ["id", "refreshDate", "parentId", "testPlanId", "name", "type", "saveStructure", "autoRefresh"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestSuiteV2GetModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestSuiteV2GetModel:
        """Create an instance of TestSuiteV2GetModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestSuiteV2GetModel.parse_obj(obj)

        _obj = TestSuiteV2GetModel.parse_obj({
            "id": obj.get("id"),

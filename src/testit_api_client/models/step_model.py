...
class StepModel(BaseModel):
    ...
    StepModel
    """ # noqa: E501
    work_item: Optional[SharedStepModel] = Field(default=None, description="Nested shared steps are allowed", alias="workItem")
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["workItem", "id", "action", "expected", "testData", "comments", "workItemId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.work_item is None and "work_item" in self.model_fields_set:
            _dict['workItem'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workItem": SharedStepModel.from_dict(obj["workItem"]) if obj.get("workItem") is not None else None,
            "id": obj.get("id"),
...
StepModel.model_rebuild(raise_errors=False)

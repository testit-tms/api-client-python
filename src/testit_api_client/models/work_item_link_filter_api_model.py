...
class WorkItemLinkFilterApiModel(BaseModel):
    """
    WorkItemLinkFilterApiModel
    """
    types: Optional[conlist(LinkType, unique_items=True)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemLinkFilterApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemLinkFilterApiModel:
        """Create an instance of WorkItemLinkFilterApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemLinkFilterApiModel.parse_obj(obj)

        _obj = WorkItemLinkFilterApiModel.parse_obj({
            "types": obj.get("types"),
            "title": obj.get("title"),
            "urls": obj.get("urls"),

...
class ParameterShortModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParameterShortModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParameterShortModel:
        """Create an instance of ParameterShortModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParameterShortModel.parse_obj(obj)

        _obj = ParameterShortModel.parse_obj({
            "id": obj.get("id"),

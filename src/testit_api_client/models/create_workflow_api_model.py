...
class CreateWorkflowApiModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateWorkflowApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateWorkflowApiModel:
        """Create an instance of CreateWorkflowApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateWorkflowApiModel.parse_obj(obj)

        _obj = CreateWorkflowApiModel.parse_obj({
            "name": obj.get("name"),

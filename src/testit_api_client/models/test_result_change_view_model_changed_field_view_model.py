...
class TestResultChangeViewModelChangedFieldViewModel(BaseModel):
    """
    TestResultChangeViewModelChangedFieldViewModel
    """
    old_value: Optional[TestResultChangeViewModel] = Field(default=None, alias="oldValue")
    new_value: Optional[TestResultChangeViewModel] = Field(default=None, alias="newValue")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultChangeViewModelChangedFieldViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResultChangeViewModelChangedFieldViewModel:
        """Create an instance of TestResultChangeViewModelChangedFieldViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultChangeViewModelChangedFieldViewModel.parse_obj(obj)

        _obj = TestResultChangeViewModelChangedFieldViewModel.parse_obj({
            "old_value": TestResultChangeViewModel.from_dict(obj.get("oldValue")) if obj.get("oldValue") is not None else None,
            "new_value": TestResultChangeViewModel.from_dict(obj.get("newValue")) if obj.get("newValue") is not None else None
        })
        return _obj

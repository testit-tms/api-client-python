...
class TestPointShortModel(BaseModel):
    """
    TestPointShortModel
    """
    ...
    __properties = ["testSuiteId", "id", "testerId", "workItemId", "configurationId", "status", "lastTestResultId", "iterationId", "workItemMedianDuration"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPointShortModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPointShortModel:
        """Create an instance of TestPointShortModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPointShortModel.parse_obj(obj)

        _obj = TestPointShortModel.parse_obj({

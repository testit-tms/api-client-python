...
class ProjectExternalServiceSettingsApiResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectExternalServiceSettingsApiResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectExternalServiceSettingsApiResult:
        """Create an instance of ProjectExternalServiceSettingsApiResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectExternalServiceSettingsApiResult.parse_obj(obj)

        _obj = ProjectExternalServiceSettingsApiResult.parse_obj({

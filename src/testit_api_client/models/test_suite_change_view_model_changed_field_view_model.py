...
class TestSuiteChangeViewModelChangedFieldViewModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oldValue": TestSuiteChangeViewModel.from_dict(obj["oldValue"]) if obj.get("oldValue") is not None else None,
            "newValue": TestSuiteChangeViewModel.from_dict(obj["newValue"]) if obj.get("newValue") is not None else None
        })
        return _obj

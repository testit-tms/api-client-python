...
class TestSuiteChangeViewModelChangedFieldViewModel(BaseModel):
    """
    TestSuiteChangeViewModelChangedFieldViewModel
    """
    old_value: Optional[TestSuiteChangeViewModel] = Field(default=None, alias="oldValue")
    new_value: Optional[TestSuiteChangeViewModel] = Field(default=None, alias="newValue")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestSuiteChangeViewModelChangedFieldViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestSuiteChangeViewModelChangedFieldViewModel:
        """Create an instance of TestSuiteChangeViewModelChangedFieldViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestSuiteChangeViewModelChangedFieldViewModel.parse_obj(obj)

        _obj = TestSuiteChangeViewModelChangedFieldViewModel.parse_obj({
            "old_value": TestSuiteChangeViewModel.from_dict(obj.get("oldValue")) if obj.get("oldValue") is not None else None,
            "new_value": TestSuiteChangeViewModel.from_dict(obj.get("newValue")) if obj.get("newValue") is not None else None
        })
        return _obj

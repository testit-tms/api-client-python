...
class TestRunSelectModel(BaseModel):
    """
    Model containing options to filter test runs
    """ # noqa: E501
    filter: TestRunFilterModel
    extraction_model: TestRunExtractionModel = Field(description="Rules for different level entities inclusion/exclusion", alias="extractionModel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": TestRunFilterModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "extractionModel": TestRunExtractionModel.from_dict(obj["extractionModel"]) if obj.get("extractionModel") is not None else None
        })
        return _obj

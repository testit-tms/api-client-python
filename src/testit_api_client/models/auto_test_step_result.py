...
class AutoTestStepResult(BaseModel):
    ...
    step_results: Optional[conlist(AutoTestStepResult)] = Field(default=None, alias="stepResults", description="Nested step results. The maximum nesting level is 15.")
    attachments: Optional[conlist(AttachmentApiResult)] = Field(default=None, description="/// <summary>  Specifies an attachment GUID. Multiple values can be sent.  </summary>")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoTestStepResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoTestStepResult:
        """Create an instance of AutoTestStepResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutoTestStepResult.parse_obj(obj)

        _obj = AutoTestStepResult.parse_obj({
            "title": obj.get("title"),
            ...
            "step_results": [AutoTestStepResult.from_dict(_item) for _item in obj.get("stepResults")] if obj.get("stepResults") is not None else None,
...
AutoTestStepResult.update_forward_refs()

...
class TestPointFilterRequestModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPointFilterRequestModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPointFilterRequestModel:
        """Create an instance of TestPointFilterRequestModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPointFilterRequestModel.parse_obj(obj)

        _obj = TestPointFilterRequestModel.parse_obj({

...
class AutoTestNamespaceCountApiModel(BaseModel):
    ...
    count: StrictInt
    classes: List[AutoTestClassCountApiModel]
    __properties: ClassVar[List[str]] = ["name", "count", "classes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "count": obj.get("count"),
            "classes": [AutoTestClassCountApiModel.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
        return _obj

...
class TestStatusUpdateModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestStatusUpdateModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestStatusUpdateModel:
        """Create an instance of TestStatusUpdateModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestStatusUpdateModel.parse_obj(obj)

        _obj = TestStatusUpdateModel.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),

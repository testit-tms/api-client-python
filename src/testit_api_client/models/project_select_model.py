...
class ProjectSelectModel(BaseModel):
    """
    ProjectSelectModel
    """
    filter: Optional[ProjectsFilterModel] = None
    extraction_model: Optional[ProjectExtractionModel] = Field(default=None, alias="extractionModel")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectSelectModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectSelectModel:
        """Create an instance of ProjectSelectModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectSelectModel.parse_obj(obj)

        _obj = ProjectSelectModel.parse_obj({
            "filter": ProjectsFilterModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": ProjectExtractionModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

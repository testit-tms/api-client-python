...
class TestStatusModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestStatusModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestStatusModel:
        """Create an instance of TestStatusModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestStatusModel.parse_obj(obj)

        _obj = TestStatusModel.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),

...
class TestResultV2GetModel(BaseModel):
    ...
    __properties = ["configuration", "autoTest", "id", "configurationId", "workItemVersionId", "autoTestId", "message", "traces", "startedOn", "completedOn", "runByUserId", "stoppedByUserId", "testPointId", "testPoint", "testRunId", "outcome", "comment", "links", "attachments", "parameters", "properties"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestResultV2GetModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestResultV2GetModel:
        """Create an instance of TestResultV2GetModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestResultV2GetModel.parse_obj(obj)

        _obj = TestResultV2GetModel.parse_obj({
            "configuration": ConfigurationModel.from_dict(obj.get("configuration")) if obj.get("configuration") is not None else None,
            "auto_test": AutoTestModelV2GetModel.from_dict(obj.get("autoTest")) if obj.get("autoTest") is not None else None,
            "id": obj.get("id"),

...
class TestResultV2GetModel(BaseModel):
    """
    TestResultV2GetModel
    """ # noqa: E501
    configuration: Optional[ConfigurationModel] = None
    auto_test: Optional[AutoTestModelV2GetModel] = Field(default=None, alias="autoTest")
    id: StrictStr
    ...
    outcome: StrictStr = Field(description="Property can contain one of these values: Passed, Failed, InProgress, Blocked, Skipped")
    comment: Optional[StrictStr] = None
    links: Optional[List[LinkModel]] = None
    attachments: Optional[List[AttachmentModel]] = None
    parameters: Optional[Dict[str, StrictStr]] = None
    properties: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["configuration", "autoTest", "id", "configurationId", "workItemVersionId", "autoTestId", "message", "traces", "startedOn", "completedOn", "runByUserId", "stoppedByUserId", "testPointId", "testPoint", "testRunId", "outcome", "comment", "links", "attachments", "parameters", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": ConfigurationModel.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
            "autoTest": AutoTestModelV2GetModel.from_dict(obj["autoTest"]) if obj.get("autoTest") is not None else None,
            "id": obj.get("id"),
            ...
            "testPoint": TestPointShortModel.from_dict(obj["testPoint"]) if obj.get("testPoint") is not None else None,

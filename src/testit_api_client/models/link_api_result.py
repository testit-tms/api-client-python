...
class LinkApiResult(BaseModel):
    ...
    url: StrictStr = Field(default=..., description="Address can be specified without protocol, but necessarily with the domain.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkApiResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkApiResult:
        """Create an instance of LinkApiResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkApiResult.parse_obj(obj)

        _obj = LinkApiResult.parse_obj({
            "id": obj.get("id"),
            "title": obj.get("title"),
            "url": obj.get("url"),

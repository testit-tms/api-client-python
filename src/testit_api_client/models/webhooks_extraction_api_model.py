...
class WebhooksExtractionApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhooksExtractionApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhooksExtractionApiModel:
        """Create an instance of WebhooksExtractionApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhooksExtractionApiModel.parse_obj(obj)

        _obj = WebhooksExtractionApiModel.parse_obj({

...
class SearchWorkflowsApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchWorkflowsApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchWorkflowsApiModel:
        """Create an instance of SearchWorkflowsApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchWorkflowsApiModel.parse_obj(obj)

        _obj = SearchWorkflowsApiModel.parse_obj({

...
class WorkItemSelectModel(BaseModel):
    ...
    """ # noqa: E501
    filter: WorkItemFilterModel = Field(description="Collection of filters to apply to search")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": WorkItemFilterModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,

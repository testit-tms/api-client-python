...
class WebhookResponse(BaseModel):
    ...
    request_meta: StrictStr = Field(alias="requestMeta")
    response_body: StrictStr = Field(alias="responseBody")
    response_meta: StrictStr = Field(alias="responseMeta")
    __properties: ClassVar[List[str]] = ["uri", "statusCode", "requestBody", "requestMeta", "responseBody", "responseMeta"]

...
class TestPlanTestPointsGroupApiModel(BaseModel):
    ...
    display_field: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="displayField")
    __properties: ClassVar[List[str]] = ["field", "displayField"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.display_field is None and "display_field" in self.model_fields_set:

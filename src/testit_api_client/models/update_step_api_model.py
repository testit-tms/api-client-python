...
class UpdateStepApiModel(BaseModel):
    ...
    UpdateStepApiModel
    """ # noqa: E501
    id: StrictStr = Field(description="Step unique internal identifier")
    ...
    test_data: Optional[StrictStr] = Field(default=None, description="Test data for step", alias="testData")
    comments: Optional[StrictStr] = Field(default=None, description="Comments for step")
    work_item_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of workitem which relates to the step", alias="workItemId")
    __properties: ClassVar[List[str]] = ["id", "action", "expected", "testData", "comments", "workItemId"]

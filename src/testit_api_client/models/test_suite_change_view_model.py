...
class TestSuiteChangeViewModel(BaseModel):
    ...
    id: StrictStr
    name: StrictStr
    configurations: Optional[List[ShortConfiguration]] = None
    work_item_count: StrictInt = Field(alias="workItemCount")
    __properties: ClassVar[List[str]] = ["id", "name", "configurations", "workItemCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "configurations": [ShortConfiguration.from_dict(_item) for _item in obj["configurations"]] if obj.get("configurations") is not None else None,
            "workItemCount": obj.get("workItemCount")
        })
        return _obj

...
class TestSuiteWorkItemsSearchModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tagNames", "entityTypes", "nameOrId", "includeIds", "excludeIds", "projectIds", "links", "name", "ids", "globalIds", "attributes", "isDeleted", "sectionIds", "createdByIds", "modifiedByIds", "states", "priorities", "sourceTypes", "types", "createdDate", "modifiedDate", "duration", "medianDuration", "isAutomated", "tags", "autoTestIds", "workItemVersionIds"]

...
class TestSuiteWorkItemsSearchModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tagNames", "entityTypes", "nameOrId", "includeIds", "excludeIds", "projectIds", "name", "ids", "globalIds", "attributes", "isDeleted", "sectionIds", "createdByIds", "modifiedByIds", "states", "priorities", "types", "createdDate", "modifiedDate", "duration", "medianDuration", "isAutomated", "tags", "autoTestIds", "workItemVersionIds"]

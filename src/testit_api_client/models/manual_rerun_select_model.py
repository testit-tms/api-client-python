...
class ManualRerunSelectModel(BaseModel):
    """
    ManualRerunSelectModel
    """ # noqa: E501
    extraction_model: Optional[TestResultExtractionModel] = Field(default=None, alias="extractionModel")
    filter: Optional[TestResultsFilterModel] = None
    __properties: ClassVar[List[str]] = ["extractionModel", "filter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extractionModel": TestResultExtractionModel.from_dict(obj["extractionModel"]) if obj.get("extractionModel") is not None else None,
            "filter": TestResultsFilterModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None
        })
        return _obj

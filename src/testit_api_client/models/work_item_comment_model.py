...
class WorkItemCommentModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "text", "user", "createdById", "modifiedById", "createdDate", "modifiedDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "text": obj.get("text"),
            "user": UserWithRankModel.from_dict(obj["user"]) if obj.get("user") is not None else None,

...
class ManualRerunSelectTestResultsApiModel(BaseModel):
    """
    ManualRerunSelectTestResultsApiModel
    """
    filter: Optional[TestResultsFilterApiModel] = None
    extraction_model: Optional[ManualRerunTestResultApiModel] = Field(default=None, alias="extractionModel")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManualRerunSelectTestResultsApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManualRerunSelectTestResultsApiModel:
        """Create an instance of ManualRerunSelectTestResultsApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManualRerunSelectTestResultsApiModel.parse_obj(obj)

        _obj = ManualRerunSelectTestResultsApiModel.parse_obj({
            "filter": TestResultsFilterApiModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": ManualRerunTestResultApiModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

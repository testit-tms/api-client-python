...
class AutoTestStepResultsApiResult(BaseModel):
    ...
    step_results: Optional[conlist(AutoTestStepResultsApiResult)] = Field(default=None, alias="stepResults")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AutoTestStepResultsApiResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AutoTestStepResultsApiResult:
        """Create an instance of AutoTestStepResultsApiResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AutoTestStepResultsApiResult.parse_obj(obj)

        _obj = AutoTestStepResultsApiResult.parse_obj({
            "title": obj.get("title"),
            ...
            "step_results": [AutoTestStepResultsApiResult.from_dict(_item) for _item in obj.get("stepResults")] if obj.get("stepResults") is not None else None,
...
AutoTestStepResultsApiResult.update_forward_refs()

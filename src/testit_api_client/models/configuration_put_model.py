...
class ConfigurationPutModel(BaseModel):
    """
    ...
    __properties = ["id", "description", "parameters", "projectId", "isDefault", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigurationPutModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigurationPutModel:
        """Create an instance of ConfigurationPutModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigurationPutModel.parse_obj(obj)

        _obj = ConfigurationPutModel.parse_obj({
            "id": obj.get("id"),

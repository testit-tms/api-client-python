...
class WebhooksUpdateApiModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filter", "model", "extractor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": WebhooksFilterApiModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "model": WebhookBulkUpdateApiModel.from_dict(obj["model"]) if obj.get("model") is not None else None,
            "extractor": WebhooksExtractionApiModel.from_dict(obj["extractor"]) if obj.get("extractor") is not None else None
        })
        return _obj

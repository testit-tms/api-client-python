...
class ConfigurationSelectModel(BaseModel):
    """
    ConfigurationSelectModel
    """
    filter: Optional[ConfigurationFilterModel] = Field(default=None, description="Configuration filters collection")
    extraction_model: Optional[ConfigurationExtractionModel] = Field(default=None, alias="extractionModel", description="Rules for configurations extraction")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigurationSelectModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigurationSelectModel:
        """Create an instance of ConfigurationSelectModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigurationSelectModel.parse_obj(obj)

        _obj = ConfigurationSelectModel.parse_obj({
            "filter": ConfigurationFilterModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": ConfigurationExtractionModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

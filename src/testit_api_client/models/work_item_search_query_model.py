...
class WorkItemSearchQueryModel(BaseModel):
    """
    ...
    __properties = ["projectIds", "links", "name", "ids", "globalIds", "attributes", "isDeleted", "sectionIds", "createdByIds", "modifiedByIds", "states", "priorities", "sourceTypes", "types", "createdDate", "modifiedDate", "duration", "medianDuration", "isAutomated", "tags", "autoTestIds", "workItemVersionIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkItemSearchQueryModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkItemSearchQueryModel:
        """Create an instance of WorkItemSearchQueryModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkItemSearchQueryModel.parse_obj(obj)

        _obj = WorkItemSearchQueryModel.parse_obj({

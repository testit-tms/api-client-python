...
class TestRunSelectApiModel(BaseModel):
    ...
    extraction_model: TestRunExtractionApiModel = Field(description="Rules for different level entities inclusion/exclusion", alias="extractionModel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": TestRunFilterApiModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "extractionModel": TestRunExtractionApiModel.from_dict(obj["extractionModel"]) if obj.get("extractionModel") is not None else None
        })
        return _obj

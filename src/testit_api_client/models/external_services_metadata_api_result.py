...
class ExternalServicesMetadataApiResult(BaseModel):
    ...
    """ # noqa: E501
    data: List[ExternalServiceMetadataApiResult] = Field(description="External services metadata")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ExternalServiceMetadataApiResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj

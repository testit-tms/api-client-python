...
class TestPointsExtractionModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPointsExtractionModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPointsExtractionModel:
        """Create an instance of TestPointsExtractionModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPointsExtractionModel.parse_obj(obj)

        _obj = TestPointsExtractionModel.parse_obj({

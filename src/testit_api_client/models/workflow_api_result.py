...
class WorkflowApiResult(BaseModel):
    ...
    statuses: List[WorkflowStatusApiResult]
    __properties: ClassVar[List[str]] = ["id", "name", "isSystem", "isDefault", "statuses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statuses": [WorkflowStatusApiResult.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj

...
class WorkflowApiResult(BaseModel):
    """
    WorkflowApiResult
    """
    id: StrictStr = Field(...)
    ...
    statuses: conlist(WorkflowStatusApiResult) = Field(...)
    __properties = ["id", "name", "isSystem", "isDefault", "statuses"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowApiResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowApiResult:
        """Create an instance of WorkflowApiResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowApiResult.parse_obj(obj)

        _obj = WorkflowApiResult.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "is_system": obj.get("isSystem"),
            "is_default": obj.get("isDefault"),
            "statuses": [WorkflowStatusApiResult.from_dict(_item) for _item in obj.get("statuses")] if obj.get("statuses") is not None else None
        })
        return _obj

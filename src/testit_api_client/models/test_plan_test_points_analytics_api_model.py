...
class TestPlanTestPointsAnalyticsApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPlanTestPointsAnalyticsApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPlanTestPointsAnalyticsApiModel:
        """Create an instance of TestPlanTestPointsAnalyticsApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPlanTestPointsAnalyticsApiModel.parse_obj(obj)

        _obj = TestPlanTestPointsAnalyticsApiModel.parse_obj({

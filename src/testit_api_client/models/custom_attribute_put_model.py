...
class CustomAttributePutModel(BaseModel):
    """
    CustomAttributePutModel
    """
    id: StrictStr = Field(default=..., description="Unique ID of the attribute")
    options: Optional[conlist(CustomAttributeOptionModel)] = Field(default=None, description="Collection of the attribute options     Available for attributes of type `options` and `multiple options` only")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomAttributePutModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomAttributePutModel:
        """Create an instance of CustomAttributePutModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomAttributePutModel.parse_obj(obj)

        _obj = CustomAttributePutModel.parse_obj({
            "id": obj.get("id"),

...
class LinkPostModel(BaseModel):
    ...
    __properties = ["title", "url", "description", "type", "hasInfo"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkPostModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkPostModel:
        """Create an instance of LinkPostModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkPostModel.parse_obj(obj)

        _obj = LinkPostModel.parse_obj({
            "title": obj.get("title"),
            "url": obj.get("url"),

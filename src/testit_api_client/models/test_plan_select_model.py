...
class TestPlanSelectModel(BaseModel):
    ...
    TestPlanSelectModel
    """ # noqa: E501
    filter: ProjectTestPlansFilterModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": ProjectTestPlansFilterModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "extractionModel": TestPlanExtractionModel.from_dict(obj["extractionModel"]) if obj.get("extractionModel") is not None else None
        })
        return _obj

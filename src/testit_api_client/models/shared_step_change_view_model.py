...
class SharedStepChangeViewModel(BaseModel):
    ...
    name: StrictStr
    steps: List[WorkItemStepChangeViewModel]
    __properties: ClassVar[List[str]] = ["id", "globalId", "name", "steps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "steps": [WorkItemStepChangeViewModel.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj

from testit_api_client.models.work_item_step_change_view_model import WorkItemStepChangeViewModel
# TODO: Rewrite to not use raise_errors
SharedStepChangeViewModel.model_rebuild(raise_errors=False)

...
class TestRunV2PostShortModel(BaseModel):
    """
    TestRunV2PostShortModel
    """ # noqa: E501
    project_id: StrictStr = Field(description="This property is to link test run with a project", alias="projectId")
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    launch_source: Optional[StrictStr] = Field(default=None, alias="launchSource")
    attachments: Optional[List[AttachmentPutModel]] = None
    links: Optional[List[LinkPostModel]] = None

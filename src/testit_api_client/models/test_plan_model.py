...
class TestPlanModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "startedOn", "completedOn", "createdDate", "modifiedDate", "createdById", "modifiedById", "globalId", "isDeleted", "lockedDate", "id", "lockedById", "tags", "name", "startDate", "endDate", "description", "build", "projectId", "productName", "hasAutomaticDurationTimer", "attributes"]

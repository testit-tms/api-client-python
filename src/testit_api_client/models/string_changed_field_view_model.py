...
class StringChangedFieldViewModel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StringChangedFieldViewModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StringChangedFieldViewModel:
        """Create an instance of StringChangedFieldViewModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StringChangedFieldViewModel.parse_obj(obj)

        _obj = StringChangedFieldViewModel.parse_obj({

...
class TestResultsStatisticsResponse(BaseModel):
    """
    TestResultsStatisticsResponse
    """ # noqa: E501
    statuses: TestResultsStatisticsStatuses = Field(description="Test results counts aggregated by outcome")
    failure_categories: TestResultsStatisticsFailureCategories = Field(description="Test results counts aggregated by result failure categories", alias="failureCategories")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statuses": TestResultsStatisticsStatuses.from_dict(obj["statuses"]) if obj.get("statuses") is not None else None,
            "failureCategories": TestResultsStatisticsFailureCategories.from_dict(obj["failureCategories"]) if obj.get("failureCategories") is not None else None
        })
        return _obj

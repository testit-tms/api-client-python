...
class TestPlanTestPointsAutoTestsRerunApiModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestPlanTestPointsAutoTestsRerunApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestPlanTestPointsAutoTestsRerunApiModel:
        """Create an instance of TestPlanTestPointsAutoTestsRerunApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestPlanTestPointsAutoTestsRerunApiModel.parse_obj(obj)

        _obj = TestPlanTestPointsAutoTestsRerunApiModel.parse_obj({

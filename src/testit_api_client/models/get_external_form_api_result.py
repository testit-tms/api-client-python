...
class GetExternalFormApiResult(BaseModel):
    ...
    """ # noqa: E501
    test_result_ids: List[StrictStr] = Field(description="Linked test result IDs", alias="testResultIds")
    form: ExternalFormModel = Field(description="External form definition")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "form": ExternalFormModel.from_dict(obj["form"]) if obj.get("form") is not None else None
        })
        return _obj

...
class CustomAttributeChangeModel(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.old_attribute_name is None and "old_attribute_name" in self.model_fields_set:
            _dict['oldAttributeName'] = None

        # set to None if new_attribute_name (nullable) is None
        # and model_fields_set contains the field
        if self.new_attribute_name is None and "new_attribute_name" in self.model_fields_set:

...
class ProjectExtractionModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectExtractionModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectExtractionModel:
        """Create an instance of ProjectExtractionModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectExtractionModel.parse_obj(obj)

        _obj = ProjectExtractionModel.parse_obj({

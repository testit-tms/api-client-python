...
class TestSuiteWithChildrenModel(BaseModel):
    ...
    """ # noqa: E501
    children: Optional[List[TestSuiteWithChildrenModel]] = None
    ...
    __properties: ClassVar[List[str]] = ["children", "testerId", "parentId", "testPlanId", "name", "id", "isDeleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "children": [TestSuiteWithChildrenModel.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None,
...
TestSuiteWithChildrenModel.model_rebuild(raise_errors=False)

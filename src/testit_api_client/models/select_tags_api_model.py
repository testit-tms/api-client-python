...
class SelectTagsApiModel(BaseModel):
    ...
    extraction_model: Optional[TagsExtractionApiModel] = Field(default=None, description="Filters to extract tags", alias="extractionModel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": TagsFilterApiModel.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "extractionModel": TagsExtractionApiModel.from_dict(obj["extractionModel"]) if obj.get("extractionModel") is not None else None
        })
        return _obj

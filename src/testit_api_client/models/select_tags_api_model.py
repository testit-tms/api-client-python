...
class SelectTagsApiModel(BaseModel):
    """
    SelectTagsApiModel
    """
    filter: Optional[TagsFilterApiModel] = Field(default=None, description="Filters to select tags")
    extraction_model: Optional[TagsExtractionApiModel] = Field(default=None, alias="extractionModel", description="Filters to extract tags")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SelectTagsApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SelectTagsApiModel:
        """Create an instance of SelectTagsApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SelectTagsApiModel.parse_obj(obj)

        _obj = SelectTagsApiModel.parse_obj({
            "filter": TagsFilterApiModel.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "extraction_model": TagsExtractionApiModel.from_dict(obj.get("extractionModel")) if obj.get("extractionModel") is not None else None
        })
        return _obj

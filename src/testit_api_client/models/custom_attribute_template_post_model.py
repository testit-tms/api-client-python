...
class CustomAttributeTemplatePostModel(BaseModel):
    ...
    __properties = ["customAttributeIds", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomAttributeTemplatePostModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomAttributeTemplatePostModel:
        """Create an instance of CustomAttributeTemplatePostModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomAttributeTemplatePostModel.parse_obj(obj)

        _obj = CustomAttributeTemplatePostModel.parse_obj({

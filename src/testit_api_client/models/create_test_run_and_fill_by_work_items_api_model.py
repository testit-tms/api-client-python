...
class CreateTestRunAndFillByWorkItemsApiModel(BaseModel):
    """
    ...
    work_item_ids: conlist(StrictStr, min_items=1) = Field(default=..., alias="workItemIds", description="Specifies the work item GUIDs, from which test points are created. You can specify several GUIDs.")
    __properties = ["projectId", "testPlanId", "name", "description", "launchSource", "attachments", "links", "configurationIds", "workItemIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateTestRunAndFillByWorkItemsApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateTestRunAndFillByWorkItemsApiModel:
        """Create an instance of CreateTestRunAndFillByWorkItemsApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateTestRunAndFillByWorkItemsApiModel.parse_obj(obj)

        _obj = CreateTestRunAndFillByWorkItemsApiModel.parse_obj({
            ...
            "work_item_ids": obj.get("workItemIds")
        })
        return _obj

...
class AutoTestNamespacesCountResponse(BaseModel):
    ...
    """ # noqa: E501
    namespaces: List[AutoTestNamespaceCountApiModel]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "namespaces": [AutoTestNamespaceCountApiModel.from_dict(_item) for _item in obj["namespaces"]] if obj.get("namespaces") is not None else None
        })
        return _obj

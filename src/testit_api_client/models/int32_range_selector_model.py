...
class Int32RangeSelectorModel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Int32RangeSelectorModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Int32RangeSelectorModel:
        """Create an instance of Int32RangeSelectorModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Int32RangeSelectorModel.parse_obj(obj)

        _obj = Int32RangeSelectorModel.parse_obj({

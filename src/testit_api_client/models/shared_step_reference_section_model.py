...
class SharedStepReferenceSectionModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "hasThisSharedStepAsPrecondition", "hasThisSharedStepAsPostcondition", "createdById", "modifiedById", "createdDate", "modifiedDate", "isDeleted"]

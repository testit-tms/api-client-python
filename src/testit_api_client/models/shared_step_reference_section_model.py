...
class SharedStepReferenceSectionModel(BaseModel):
    """
    ...
    __properties = ["id", "name", "hasThisSharedStepAsPrecondition", "hasThisSharedStepAsPostcondition", "createdById", "modifiedById", "createdDate", "modifiedDate", "isDeleted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SharedStepReferenceSectionModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SharedStepReferenceSectionModel:
        """Create an instance of SharedStepReferenceSectionModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SharedStepReferenceSectionModel.parse_obj(obj)

        _obj = SharedStepReferenceSectionModel.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),

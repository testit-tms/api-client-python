...
class CreateParameterApiModel(BaseModel):
    """
    ...
    __properties = ["name", "value", "projectIds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateParameterApiModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateParameterApiModel:
        """Create an instance of CreateParameterApiModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateParameterApiModel.parse_obj(obj)

        _obj = CreateParameterApiModel.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value"),
